#!/usr/bin/env bash
# dopamine v1.3.0 — felt roulette table + blackjack betting chip (responsive).
...
S_EOF
sed -i.bak 's/version = "1.2.0"/version = "1.3.0"/; s/version = "1.1.0"/version = "1.3.0"/; s/version = "1.0.0"/version = "1.3.0"/' pyproject.toml && rm -f pyproject.toml.bak
echo ""
echo "DONE. Now run:"
echo "   git add -A && git commit -m \"v1.3.0: felt roulette table + blackjack bet chip\" && git push"
